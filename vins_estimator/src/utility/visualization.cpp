...
{
    pub_latest_odometry = n.advertise<nav_msgs::Odometry>("imu_propagate", 1000); // imu预积分结果发布器
    pub_path = n.advertise<nav_msgs::Path>("path", 1000);
    pub_relo_path = n.advertise<nav_msgs::Path>("relocalization_path", 1000); // 重定位路径
